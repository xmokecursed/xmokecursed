...
↳ &nbsp;**[Pinterest Scraper](https://github.com/xmokecursed/Pinterest-scraper)** &nbsp;`Python` `Playwright`

↳ &nbsp;**[Mic Link](https://github.com/xmokecursed/Miclink)** &nbsp;`Kotlin` `Python`
